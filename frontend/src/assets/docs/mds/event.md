...
EVENT.Unit = {
    ...
    Synthesis = {
        --- 合成
        ---@alias noteOnUnitSynthesisConflateData noteOnUnitBase|{triggerTpl:Tpl}
        Conflate = "unitSynthesisConflate",
        --- 拆分
        ---@alias noteOnUnitSynthesisSeparateData noteOnUnitBase|{triggerTpl:Tpl}
        Separate = "unitSynthesisSeparate",
    }
}
...
---@alias noteOnDestructableBase {triggerRegion:Region,triggerDestructable:number|Destructable}
EVENT.Destructable = {
    --- 可破坏物死亡
